...
export default function Releases() {
  ...
  const navItems = [
    { id: "section-1", title: "1. Latest Updates", icon: Star },
    { id: "section-2", title: "2. Version History", icon: History },
    { id: "section-3", title: "3. Upcoming Roadmap", icon: Map },
    { id: "section-4", title: "4. Beta Programs", icon: Beaker },
  ];
      ...
      <section className="relative pt-36 md:pt-44 pb-16 px-6 md:px-12 lg:px-16 overflow-hidden bg-[#0A0710]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4.5 py-1.5 rounded-full bg-transparent border border-[#705474]/30 text-[#705474] font-mono text-[11px] uppercase tracking-[0.2em] font-bold shadow-[0_0_40px_rgba(139,47,209,0.15)] mb-6">
            <Rocket className="w-3.5 h-3.5 text-[#705474]" />
            <span>CHANGELOG</span>
          </div>

          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight mb-6">
            <ShinyText text="Product Releases" color="#f1eef1" shineColor="#705474" speed={3} />
          </h1>

          <p className="text-[#f1eef1]/70 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-light mb-8">
            Stay up to date with our latest software updates, feature rollouts, and technical improvements to the Devoxa ecosystem.
          </p>
        </div>
      </section>
            ...
            <div className="sticky top-28 space-y-6">
              <div className="bg-transparent border border-[#705474]/20 rounded-3xl p-6 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)]">
                <h3 className="text-xs font-mono font-bold tracking-widest text-[#705474] uppercase mb-4 pb-3 border-b border-[#705474]/15 flex items-center justify-between">
                  <span>DIRECTORY</span>
                  <History className="w-4 h-4 text-[#705474]" />
                </h3>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div id="section-1" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-2xl bg-[#2B0F45]/50 border border-[#705474]/20 hover:border-[#705474]/50 transition-colors">
                  <div className="flex items-center justify-between mb-3">
                    <span className="px-3 py-1 bg-[#523056] text-[#f1eef1] text-[10px] font-mono font-bold rounded-full">v2.4.0 — NEW</span>
                    <span className="text-[#f1eef1]/50 text-xs">August 2026</span>
                  </div>
                  <h3 className="font-bold text-[#f1eef1] text-base mb-2">AI-Powered Content Generation Engine</h3>
                  <p className="text-[#f1eef1]/70 text-sm leading-relaxed font-light mb-3">
                    We've rolled out a massive update to our core platform, introducing generative AI tools directly into the dashboard. You can now auto-generate copy, optimize meta tags, and suggest layout improvements with a single click.
                  </p>
                  <ul className="list-disc list-inside text-xs text-[#f1eef1]/60 space-y-1">
                    <li>Added `gpt-4o` integrations for rich text fields.</li>
                    <li>Improved image optimization pipeline (WebP conversion is now 40% faster).</li>
                    <li>Fixed a minor rendering bug in the mobile navigation popover.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div id="section-2" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="space-y-4">
                <div className="p-5 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#f1eef1] text-xs font-mono font-bold">v2.3.5 — Performance Patch</span>
                    <span className="text-[#f1eef1]/50 text-xs">June 2026</span>
                  </div>
                  <p className="text-[#f1eef1]/70 text-xs leading-relaxed font-light">
                    Overhauled the WebGL rendering pipeline for our interactive backgrounds. Reduced main-thread blocking time by 60ms.
                  </p>
                </div>
                
                <div className="p-5 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-[#f1eef1] text-xs font-mono font-bold">v2.3.0 — Enterprise SSO</span>
                    <span className="text-[#f1eef1]/50 text-xs">April 2026</span>
                  </div>
                  <p className="text-[#f1eef1]/70 text-xs leading-relaxed font-light">
                    Introduced Single Sign-On (SSO) support for enterprise clients using Okta and Azure AD.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="section-3" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <p className="text-[#f1eef1]/70 text-xs sm:text-sm leading-relaxed font-light">
                Here's a sneak peek at what the engineering team is currently working on:
              </p>
              <div className="space-y-3 mt-4">
                <div className="flex items-center gap-3 p-3 rounded-xl border border-[#705474]/20 bg-[#2B0F45]/50">
                  <div className="w-2 h-2 rounded-full bg-yellow-400 shrink-0"></div>
                  <span className="text-sm text-[#f1eef1]">Native iOS App Dashboard Companion</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl border border-[#705474]/20 bg-[#2B0F45]/50">
                  <div className="w-2 h-2 rounded-full bg-yellow-400 shrink-0"></div>
                  <span className="text-sm text-[#f1eef1]">Advanced GraphQL API endpoint exposure for Enterprise</span>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl border border-[#705474]/20 bg-[#2B0F45]/50">
                  <div className="w-2 h-2 rounded-full bg-yellow-400 shrink-0"></div>
                  <span className="text-sm text-[#f1eef1]">Automated infrastructure scaling configurations</span>
                </div>
              </div>
            </div>
            ...
            <div id="section-4" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <p className="text-[#f1eef1]/70 text-xs sm:text-sm leading-relaxed font-light">
                Want to test out features before they hit the main servers? We regularly invite active clients to our closed beta programs.
              </p>
              <button
                onClick={() => setIsModalOpen(true)}
