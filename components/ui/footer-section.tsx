	...
	return (
		...
		>
			...
			<div className="w-full flex flex-col flex-1 border border-dashed border-gray-500/50 p-2">
				{/* Middle Section */}
				<div className="flex flex-col lg:flex-row w-full justify-center gap-12 lg:gap-48 xl:gap-64 relative border border-dashed border-gray-500/50 p-2" style={{ paddingTop: '1.75rem', marginBottom: '0' }}>
