...
export function Footer() {
	return (
		...
		>
			...
			<div className="w-full max-w-[90rem] mx-auto flex flex-col flex-1">
				{/* Middle Section */}
				<div className="flex flex-col lg:flex-row w-full justify-end lg:pr-16 xl:pr-32 gap-12 lg:gap-32 relative" style={{ paddingTop: '1.75rem', marginBottom: '0' }}>
