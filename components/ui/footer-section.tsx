	...
	return (
		...
		>
			...
			<div className="w-full max-w-7xl mx-auto flex flex-col flex-1 border border-dashed border-gray-500/50 p-2">
				{/* Middle Section */}
				<div className="grid w-full gap-8 lg:gap-12 lg:grid-cols-12 relative border border-dashed border-gray-500/50 p-2" style={{ paddingTop: '1.75rem', marginBottom: '0' }}>

					{/* Left CTA */}
					<AnimatedContainer delay={0.2} className="lg:col-span-4 lg:col-start-2 flex flex-col items-start pl-3 sm:pl-0 border border-dashed border-gray-500/50 p-2">
					...
					{/* Middle Links */}
					<div className="lg:col-span-6 lg:col-start-7 grid grid-cols-2 sm:grid-cols-3 gap-6 lg:gap-8 pt-4 lg:pt-2 border border-dashed border-gray-500/50 p-2">
						{footerLinks.map((section: FooterSection, index: number) => (
							<AnimatedContainer key={section.label} delay={0.3 + index * 0.1}>
								<div className="mb-6 md:mb-0 border border-dashed border-gray-500/50 p-2">
				...
				{/* Bottom Wrapper */}
				<div className="mt-8 w-full flex flex-col relative border border-dashed border-gray-500/50 p-2">
					{/* Massive Watermark */}
