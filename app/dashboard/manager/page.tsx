            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="flex flex-wrap gap-2 mb-8 border-b border-border pb-4">
                    <button
                        ...
                        className={`px-5 py-2.5 rounded-full text-sm font-bold transition-all ${activeTab === "pipeline" ? "bg-studio-black text-[#FFFFFF] shadow-md" : "text-secondary hover:bg-neutral-100 hover:text-foreground"}`}
                    >
                            ...
                            <div className="space-y-2">
                                {assignments.map(lead => (
                                    <button
                                        ...
                                        className={`w-full p-4 rounded-xl text-left transition-all border ${selectedLead?._id === lead._id ? "bg-studio-black text-[#FFFFFF] border-studio-black shadow-lg" : "bg-card border-border hover:bg-surface-container-low"}`}
                                    >
                                        ...
                                        <span className={`mt-2 inline-block text-[9px] font-bold uppercase tracking-widest px-2 py-1 rounded-sm border ${lead.dealStatus === 'won' ? 'bg-green-500/10 text-green-500 border-green-500/20' :
                                            lead.dealStatus === 'lost' ? 'bg-red-500/10 text-red-500 border-red-500/20' :
                                                selectedLead?._id === lead._id ? 'bg-white/10 text-[#FFFFFF] border-white/20' : 'bg-neutral-100 text-neutral-500 border-border'
                                            }`}>
                            ...
                            {selectedLead ? (
                                <>
                                        ...
                                        <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                                            ...
                                            <div className="flex bg-neutral-100 rounded-lg p-1 border border-neutral-200">
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-md transition-all ${selectedLead.dealStatus === 'lost' ? 'bg-red-500 text-[#FFFFFF] shadow-sm' : 'text-neutral-500 hover:text-red-500'}`}
                                                >Lost</button>
                                                <button
                                                    disabled={updating}
                                                    onClick={() => handleDealStatusUpdate('won')}
                                                    className={`px-4 py-2 text-xs font-bold uppercase tracking-wider rounded-md transition-all ${selectedLead.dealStatus === 'won' ? 'bg-green-500 text-[#FFFFFF] shadow-sm' : 'text-neutral-500 hover:text-green-500'}`}
                                                >Won</button>
                                            </div>
                                        </div>
                                            ...
                                            <div className="flex flex-col gap-2 p-4 rounded-xl border border-border bg-neutral-50/50 hover:bg-neutral-50 transition-colors">
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    <button
                                                        ...
                                                        className={`relative flex items-center justify-center w-6 h-6 rounded-md border transition-all ${selectedLead.managerChecklist?.clientBrief ? 'bg-studio-black border-studio-black text-[#FFFFFF]' : 'bg-white border-neutral-300 text-transparent'}`}
                                                    >
                                            ...
                                            <div className="flex flex-col gap-2 p-4 rounded-xl border border-border bg-neutral-50/50 hover:bg-neutral-50 transition-colors">
                                                ...
                                                <div className="flex items-center gap-3 mt-1">
                                                    <button
                                                        ...
                                                        className={`relative flex items-center justify-center w-6 h-6 rounded-md border transition-all ${selectedLead.managerChecklist?.proposalSent ? 'bg-studio-black border-studio-black text-[#FFFFFF]' : 'bg-white border-neutral-300 text-transparent'}`}
                                                    >
                                                        <CheckCircle2 className="w-4 h-4" />
                                                    </button>
                                    ...
                                    <div className="rounded-2xl overflow-hidden border border-border shadow-sm">
                                        <div className="bg-studio-black text-[#FFFFFF] px-6 py-4 flex items-center justify-between">
