	...
	return (
		...
		>
			...
			<div className="w-full max-w-md mx-auto flex flex-col gap-8">
				...
				{/* Left CTA */}
				<AnimatedContainer delay={0.2} className="flex flex-col items-start w-full" style={{ paddingLeft: "16px" }}>
					<h2 className="text-2xl font-serif text-white leading-tight" style={{ margin: "0 0 12px 0", paddingLeft: "4px" }}>
						Let's build something<br />
						amazing <span className="text-[#a78bfa]">together.</span>
					</h2>
					<p className="text-gray-400 text-xs leading-relaxed max-w-xs" style={{ paddingLeft: "4px", marginBottom: "0px" }}>
						We partner with ambitious businesses to design, build and scale digital products that drive real impact.
					</p>

					{/* Contact Info */}
					<div className="flex flex-col w-full gap-3" style={{ paddingLeft: "4px", marginTop: "16px", marginBottom: "12px" }}>
					...
					{/* Social Media Icons */}
					<div className="flex text-gray-400 gap-10 sm:gap-8 w-full justify-center items-center" style={{ marginTop: "16px", marginBottom: "12px" }}>
				...
				<div className="grid grid-cols-2 gap-6 pt-6 border-t border-white/5" style={{ paddingLeft: "20px" }}>
