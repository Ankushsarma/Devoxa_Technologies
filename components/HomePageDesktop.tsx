  ...
  return (
    <main className="bg-background text-foreground font-sans selection:bg-black selection:text-white overflow-x-hidden">
      ...
      <a
        ...
        className="hidden md:flex fixed bottom-6 left-6 z-50 bg-[#25D366] hover:bg-[#1ebd57] text-white p-3 rounded-full shadow-lg shadow-[#25d366]/30 transition-transform hover:scale-110 items-center justify-center cursor-pointer"
