...
export function FooterMobile() {
	return (
		<footer
			className="relative w-full flex flex-col justify-start rounded-t-3xl border-t border-[#8B2FD1]/15 bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)] overflow-hidden"
		...
		>
			...
			<div className="w-full max-w-2xl md:max-w-4xl mx-auto flex flex-col gap-8 px-2 sm:px-6">
				...
				<AnimatedContainer delay={0.2} className="flex flex-col items-start sm:items-center text-left sm:text-center w-full">
					<h2 className="text-2xl sm:text-3xl font-serif text-[#FFFFFF] leading-tight mb-3">
						Let's build something<br />
						amazing <span className="text-[#8B2FD1]">together.</span>
					</h2>
					<p className="text-[#FFFFFF]/60 text-xs sm:text-sm leading-relaxed max-w-xs sm:max-w-sm mb-0">
					...
					<div className="flex flex-col sm:flex-row w-full gap-4 sm:justify-center mt-5 mb-4">
						...
						<a href="mailto:support@devoxatechnologies.com" className="flex items-center gap-3 text-[#FFFFFF]/70 hover:text-[#FFFFFF] transition-colors duration-300 w-full sm:w-auto overflow-hidden">
							<div className="w-8 h-8 rounded-full bg-transparent flex items-center justify-center border border-[#8B2FD1]/15 shrink-0">
					...
					{/* Social Media Icons */}
					<div className="flex text-[#FFFFFF]/60 gap-8 sm:gap-10 w-full justify-center items-center mt-4 mb-3">
						<a href="#" className="w-10 h-10 rounded-full border border-[#8B2FD1]/15 flex items-center justify-center hover:text-[#FFFFFF] hover:border-white/30 transition-all bg-transparent">
				...
				<div className="grid grid-cols-2 sm:grid-cols-3 gap-6 pt-6 border-t border-white/5">
					{footerLinks.map((section: FooterSection, index: number) => (
						<AnimatedContainer key={section.label} delay={0.3 + index * 0.1}>
							<div>
								<h3 className="text-[#FFFFFF] text-[11px] font-semibold tracking-wider uppercase flex flex-col mb-3">
									{section.label}
									<div className="w-4 h-[2px] bg-[#8B2FD1]/50 mt-1"></div>
								</h3>
								<LineSidebar
				...
				<div className="w-full flex flex-col items-center justify-center pt-2 border-t border-white/5 pb-0">
					...
					<AnimatedContainer delay={0.7} className="w-full flex justify-center items-center pt-1 pb-0 mb-0">
						<p className="text-[#FFFFFF]/50 text-[11px] text-center mb-0 pb-0">
