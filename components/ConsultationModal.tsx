      ...
      >
        ...
        <div className="md:w-2/5 p-8 md:p-10 relative overflow-hidden flex flex-col justify-center"
          ...
          <div className="relative z-10">
            <h3 className="text-3xl font-semibold text-white mb-4 font-serif leading-tight">
            ...
            <p className="text-sm text-purple-200/70 leading-relaxed mb-10">
        ...
        <div className="md:w-3/5 p-8 md:p-10 relative bg-[#141415] bg-[radial-gradient(35%_128px_at_50%_0%,theme(backgroundColor.white/8%),transparent)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-xs font-semibold text-[#8981A6] mb-2 tracking-wider">NAME <span className="text-red-400">*</span></label>
                <input
                  required
                  type="text"
                  value={formState.name}
                  onChange={(e) => setFormState({ ...formState, name: e.target.value })}
                  className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3.5 text-sm text-white placeholder-white/20 focus:border-[#a78bfa] focus:bg-white/10 focus:outline-none transition-all"
                  placeholder="John Doe"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-[#8981A6] mb-2 tracking-wider">EMAIL <span className="text-red-400">*</span></label>
                <input
                  required
                  type="email"
              ...
              <div>
                <label className="block text-xs font-semibold text-[#8981A6] mb-2 tracking-wider">PHONE</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="block text-xs font-semibold text-[#8981A6] mb-2 tracking-wider">COMPANY</label>
                <input
                  type="text"
            ...
            <div>
              <label className="block text-xs font-semibold text-[#8981A6] mb-2 tracking-wider">PROJECT DETAILS</label>
              <textarea
                value={formState.message}
                onChange={(e) => setFormState({ ...formState, message: e.target.value })}
                className="w-full rounded-xl bg-white/5 border border-white/10 px-4 py-3.5 text-sm text-white placeholder-white/20 focus:border-[#a78bfa] focus:bg-white/10 focus:outline-none transition-all resize-none h-32"
            ...
            <button
              ...
              className="w-full mt-2 rounded-xl py-4 text-sm font-bold text-white shadow-lg hover:shadow-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed hover:-translate-y-0.5"
              style={{
