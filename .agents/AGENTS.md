...
- **Mobile Footer Integrity**: Do NOT modify `footer-section-mobile.tsx` or any mobile footer layouts. The mobile mode footer layout is locked and must not be changed unless explicitly requested by the user.
