...
export default function Status() {
  ...
  const navItems = [
    { id: "section-1", title: "1. Current Status", icon: Activity },
    { id: "section-2", title: "2. Uptime History", icon: Clock },
    { id: "section-3", title: "3. Incident Reports", icon: AlertTriangle },
    { id: "section-4", title: "4. Scheduled Maintenance", icon: CalendarDays },
  ];
      ...
      <section className="relative pt-36 md:pt-44 pb-16 px-6 md:px-12 lg:px-16 overflow-hidden bg-[#0A0710]">
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center flex flex-col items-center">
          ...
          <div className="inline-flex items-center gap-2 px-4.5 py-1.5 rounded-full bg-transparent border border-[#705474]/30 text-[#705474] font-mono text-[11px] uppercase tracking-[0.2em] font-bold shadow-[0_0_40px_rgba(139,47,209,0.15)] mb-6">
            <Activity className="w-3.5 h-3.5 text-[#705474]" />
            <span>OPERATIONS</span>
          </div>

          <h1 className="text-4xl sm:text-6xl md:text-7xl font-extrabold tracking-tight mb-6">
            <ShinyText text="System Status" color="#f1eef1" shineColor="#705474" speed={3} />
          </h1>

          <p className="text-[#f1eef1]/70 text-sm sm:text-base md:text-lg max-w-2xl mx-auto leading-relaxed font-light mb-8">
            Real-time insights into our infrastructure health. We believe in complete transparency regarding uptime and incident reports.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10">
            ...
            <div className="sticky top-28 space-y-6">
              <div className="bg-transparent border border-[#705474]/20 rounded-3xl p-6 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)]">
                <h3 className="text-xs font-mono font-bold tracking-widest text-[#705474] uppercase mb-4 pb-3 border-b border-[#705474]/15 flex items-center justify-between">
                  <span>DIRECTORY</span>
                  <Activity className="w-4 h-4 text-[#705474]" />
                </h3>
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div id="section-1" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="p-6 rounded-2xl bg-[#2B0F45]/50 border border-green-500/30 flex items-center gap-4 mt-2">
                <div className="w-4 h-4 rounded-full bg-green-500 animate-pulse shrink-0 shadow-[0_0_15px_rgba(34,197,94,0.5)]"></div>
                <div>
                  <h3 className="font-bold text-green-400 text-lg">All Systems Operational</h3>
                  <p className="text-[#f1eef1]/50 text-xs mt-1">Last updated: Just now</p>
                </div>
              </div>
            </div>
            ...
            <div id="section-2" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15 text-center">
                  <span className="text-2xl font-bold text-[#f1eef1]">99.99%</span>
                  <span className="text-[10px] font-mono text-[#f1eef1]/50 uppercase tracking-wider block mt-1">Last 24h</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15 text-center">
                  <span className="text-2xl font-bold text-[#f1eef1]">99.98%</span>
                  <span className="text-[10px] font-mono text-[#f1eef1]/50 uppercase tracking-wider block mt-1">Last 7 Days</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15 text-center">
                  <span className="text-2xl font-bold text-[#f1eef1]">99.99%</span>
                  <span className="text-[10px] font-mono text-[#f1eef1]/50 uppercase tracking-wider block mt-1">Last 30 Days</span>
                </div>
                <div className="p-4 rounded-2xl bg-[#2B0F45]/30 border border-[#705474]/15 text-center">
                  <span className="text-2xl font-bold text-[#f1eef1]">100%</span>
                  <span className="text-[10px] font-mono text-[#f1eef1]/50 uppercase tracking-wider block mt-1">Last 90 Days</span>
                </div>
              </div>
            </div>
            ...
            <div id="section-3" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="p-8 text-center text-[#f1eef1]/50 border border-dashed border-[#705474]/30 rounded-2xl mt-4">
                <CheckCircle2 className="w-8 h-8 text-[#705474]/50 mx-auto mb-3" />
                <p className="text-sm font-semibold">No incidents reported in the last 90 days.</p>
              </div>
            </div>
            ...
            <div id="section-4" className="scroll-mt-32 p-6 sm:p-8 rounded-3xl bg-transparent border border-[#705474]/20 backdrop-blur-xl shadow-[0_0_40px_rgba(139,47,209,0.15)] hover:border-[#705474]/40 transition-all duration-300 space-y-4">
              ...
              <div className="p-8 text-center text-[#f1eef1]/50 border border-dashed border-[#705474]/30 rounded-2xl mt-4">
                <CalendarDays className="w-8 h-8 text-[#705474]/50 mx-auto mb-3" />
                <p className="text-sm font-semibold">No scheduled maintenance at this time.</p>
              </div>
            </div>
